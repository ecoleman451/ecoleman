...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 1850 }, { marker: 'pandoc', elapsed: 310 }, { marker: 'post-processor', elapsed: 90 }, { marker: 'pre-processor', elapsed: 20 }, { marker: 'render', elapsed: 3260 } ];

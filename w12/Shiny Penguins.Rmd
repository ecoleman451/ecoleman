---
title: "Penguin Analysis with Shiny"
...
# Embedding Shinyapps in HTML

We can also embed standalone apps within any HTML presentation by HTML tag `<iframe>`. The following is an example of embedding the app showing the basics of linear correlation and linear regression.

````{verbatim}

<center><div class='wrap'>
<iframe src="https://chengpeng.shinyapps.io/correlation-reg/" height="1000" width="1500" title="Iframe Example"></iframe>
</div></center>
